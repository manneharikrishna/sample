...
RSpec.describe Deposits::ConfigureSubscriptionPayload, nets: true do
  ...
  it 'configures a deposit payload' do
    ...
    expect(result['recurring_frequency']).to be_present
    expect(result['recurring_expiry_date']).to be_present
  end
end
